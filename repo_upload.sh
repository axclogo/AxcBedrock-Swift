...
# 这里设置要上传的版本号
new_version="1.0.1"
pod_sources="https://github.com/CocoaPods/Specs"
...
echo "正在添加变更"
rand_str=$RANDOM
echo $rand_str >> $podspec_file
echo "检查文件状态"
git status -s
echo "提交变更文件"
git add $podspec_file # .podspec变更
git add $podspec_bak_file # .podspec.bak变更
git add "Example/AxcBedrock.xcodeproj/project.pbxproj" # .pbxproj变更，因为该脚本也会变更
