...
struct iOS_WidgetLiveActivity_Previews: PreviewProvider {
    static let attributes = iOS_WidgetAttributes(name: "Me")
    static let contentState = iOS_WidgetAttributes.ContentState(value: 3)
