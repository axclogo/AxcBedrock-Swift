...
@property(nonatomic, assign) AxcButtonContentLayoutStyle axcContentLayoutType;

/* 图文间距，默认为：0 */
@property (nonatomic, assign) CGFloat axcPadding;

/* 图文边界的间距，默认为：5 */
@property (nonatomic, assign) CGFloat axcPaddingInset;
