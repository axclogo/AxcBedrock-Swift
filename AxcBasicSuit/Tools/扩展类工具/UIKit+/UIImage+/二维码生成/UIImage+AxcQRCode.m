...
+ (UIImage *)AxcTool_codeImageWithString:(NSString *)string
                                size:(CGFloat)width{
...
+ (UIImage *_Nonnull)AxcTool_codeImageWithString:(NSString *_Nullable)string
                                        size:(CGFloat)width
                                       color:(UIColor *_Nullable)color;{
    
    
    UIImage *image = [UIImage AxcTool_codeImageWithString:string size:width];
...
+ (UIImage *_Nonnull)AxcTool_codeImageWithString:(NSString *_Nullable)string
    ...
    UIImage *bgImage = [UIImage AxcTool_codeImageWithString:string
                                                       size:width
                                                      color:color];
