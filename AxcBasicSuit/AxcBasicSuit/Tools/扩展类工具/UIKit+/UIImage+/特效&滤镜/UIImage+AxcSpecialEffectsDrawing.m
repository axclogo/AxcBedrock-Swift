...
- (UIImage *)AxcTool_drawingWithGaussianBlur{
    return [self AxcTool_drawingWithGaussianBlurNumber:0.5];
}
...
- (UIImage *)AxcTool_drawingWithDilateIterations:(int)iterations{
    ...
    for (int i=0; i<iterations; i++) {
        dstImage = [dstImage AxcTool_drawingWithDilate];
    }
    return dstImage;
}
...
- (UIImage *)AxcTool_drawingWithErodeIterations:(int)iterations{
    UIImage *dstImage = self;
    for (int i=0; i<iterations; i++) {
        dstImage = [dstImage AxcTool_drawingWithErode];
    }
    return dstImage;
}

- (UIImage *)AxcTool_drawingWithGradientIterations:(int)iterations{
    UIImage *dilated = [self AxcTool_drawingWithDilateIterations:iterations];
    UIImage *eroded = [self AxcTool_drawingWithErodeIterations:iterations];
    UIImage *dstImage = [dilated AxcTool_imageBlendedWithImage:eroded blendMode:kCGBlendModeDifference alpha:1.0];
    return dstImage;
}

- (UIImage *)AxcTool_drawingWithTophatIterations:(int)iterations {
    UIImage *dilated = [self AxcTool_drawingWithDilateIterations:iterations];
    UIImage *dstImage = [self AxcTool_imageBlendedWithImage:dilated blendMode:kCGBlendModeDifference alpha:1.0];
    return dstImage;
}

- (UIImage *)AxcTool_drawingWithBlackhatIterations:(int)iterations {
    UIImage *eroded = [self AxcTool_drawingWithErodeIterations:iterations];
    UIImage *dstImage = [eroded AxcTool_imageBlendedWithImage:self blendMode:kCGBlendModeDifference alpha:1.0];
    return dstImage;
}
